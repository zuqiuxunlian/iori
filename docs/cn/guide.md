...
<img src="./images/pro/Pro Max.jpg" width="500"/>
...
- TAP：起点终点使用，按住松手开始
  - TAPX：显示增强；在 TAP 模式双击进入；可在起点显示多个分段成绩
- SPT：分段计时，放置在起点和终点之间
...
- TWIN：分组设置，同一小组自动互联
- TRIS: ON/OFF, 是否允许红外触发开始；行进间测试需要置 ON
...
<img src="./images/pro/Pro Max-Tripod.jpg" width="500"/>
...
使用 Type-C 接口充电器给设备充电。电源灯红色充电，充满灭灯。经过实际测试，完全充满约需要 3 小时，充满可以使用 10 小时。

早期产品（无电源灯为早期产品）充电时必须同时**把电源开关打开**。可联系我们免费升级。
